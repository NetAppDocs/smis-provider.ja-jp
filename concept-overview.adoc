...
summary: NetApp SMI-S Provider 5.2.7 では、ストレージシステムの管理と監視、ストレージシステムの LUN とボリュームの管理、 CIMOM 設定、および CIM サーバのユーザを実行できます。 
---
= 概要
:allow-uri-read: 
:icons: font
...
[role="lead"]
NetApp SMI-S Provider 5.2.7 では、ストレージシステムの管理と監視、ストレージシステムの LUN とボリュームの管理、 CIMOM 設定、および CIM サーバのユーザを実行できます。
...
* http://www.dmtf.org["Distributed Management Task Force （ DMTF ；分散管理タスクフォース）"^]
