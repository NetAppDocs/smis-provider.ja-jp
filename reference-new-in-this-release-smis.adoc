...
[role="lead"]
NetApp SMI-S Provider 5.2.7では、サポートされるWindowsおよびSystem Center Virtual Machine Manager（SCVMM）のバージョンなど、新たな要件と制限事項が導入されています。このリリースにデプロイまたはアップグレードする前に、これらの変更点を確認してください。
